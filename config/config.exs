...
config :undi_online, UndiOnlineWeb.Endpoint,
  ...
  live_view: [signing_salt: "DTe7WkJq"]
...
config :undi_online, UndiOnline.Users.Guardian,
  issuer: "undi_online",
  secret_key: System.get_env("GUARDIAN_SECRET_KEY_ADMINS") || "1R4E3RxxSPirOMF7sDn222jYBfZHmQQ6BthQHFJZ7vCeZ2hc5jw7cKTG4KDC0+Oq"

config :undi_online, UndiOnline.Admins.Guardian,
  issuer: "undi_online",
  secret_key: System.get_env("GUARDIAN_SECRET_KEY_ADMINS") || "0p+gqAqTWzk/D9+nmX9HXQZvwPGkERfrNUXVeAm9BuVADmRRUqlFnUmE7/+HHv1V"
